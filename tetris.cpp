...
std::istream& operator>>(std::istream& is, piece& p){
    ...
    if(c_is_int(is.peek())){
        ...
        throw tetris_exception("piece operator>> 1: expected int ");
    }
    ...
    if(c_is_int(is.peek())){
        ...
        throw tetris_exception("piece operator>> 2: expected int");
    }
...
std::istream& operator>>(std::istream& is, tetris& t){
    ...
    if(c_is_int(is.peek())){
        ...
        throw tetris_exception("tetris operator>>: expected score int");
    }
    ...
    if(c_is_int(is.peek())){
        ...
        throw tetris_exception("tetris operator>>: expected width int");
    }
    ...
    if(c_is_int(is.peek())){
        ...
        throw tetris_exception("tetris operator>>: expected height int");
    }
